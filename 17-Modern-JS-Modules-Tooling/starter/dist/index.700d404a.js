 ...
 */function(t,n){if(n)return t.slice();var r=t.length,e=a?a(r):new t.constructor(r);return t.copy(e),e}});var c=//import { addToCart, tp, totalQuantity as tq } from "./shoppingCart.js";
 ...
 */function(){var t=this.__wrapped__.value(),n=this.__dir__,r=H(t),e=n<0,i=r?t.length:0,o=f9(0,i,this.__views__),u=o.start,a=o.end,f=a-u,c=e?a:u-1,l=this.__iteratees__,s=l.length,p=0,h=f4(f,this.__takeCount__);if(!r||!e&&i==f&&h==f)return am(t,this.__actions__);var v=[];t:for(;f--&&p<h;){for(var d=-1,y=t[c+=n];++d<s;){var g=l[d],_=g.iteratee,b=g.type,m=_(y);if(2==b)y=m;else if(!m){if(1==b)continue t;break t}}v[p++]=y}return v},iR.prototype.at=aj.at,iR.prototype.chain=aj.wrapperChain,iR.prototype.commit=aj.commit,iR.prototype.next=aj.next,iR.prototype.plant=aj.plant,iR.prototype.reverse=aj.reverse,iR.prototype.toJSON=iR.prototype.valueOf=iR.prototype.value=aj.value,iR.prototype.first=iR.prototype.head,f7&&(iR.prototype[f7]=aj.toIterator);const cr={cart:[{product:"bread",quantity:5},{product:"pizza",quantity:5}],user:{loggedIn:!0}},ce=Object.assign({},cr),ci=iR(cr);cr.user.loggedIn=!1,console.log(ce),console.log(ci);//# sourceMappingURL=index.700d404a.js.map

//# sourceMappingURL=index.700d404a.js.map
